...
const require = createRequire(import.meta.url)
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'ExcelJS'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
...
export async function exportToExcel(blocks: ExporterBlock[], sourceFileName?: string): Promise<Buffer> {
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'exportedAt'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'blockCount'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  let blockCount = 0
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'currentHeading'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'overviewSheet'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'row'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'outlineSheet'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'outHdr'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'mainSheet'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'titleRow2'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'excelRowIdx'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  let excelRowIdx = 3
  // [RUN-TIME STATE / INVARIANT] - 변수 'tableCountMain'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  let tableCountMain = 0
  let headingPathMain: string[] = []

  // [RUN-TIME STATE / INVARIANT] - 변수 'writeBlockToExcel'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  const writeBlockToExcel = (block: ExporterBlock, depth = 0) => {
  // [RUN-TIME STATE / INVARIANT] - 변수 'text'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
    const text = getPlainTextFromNormalized(block)
  // [RUN-TIME STATE / INVARIANT] - 변수 'indentCol'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'sheetName'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
          const sheetName = `\ud45c_${tableCountMain}`.slice(0, 31)
  // [RUN-TIME STATE / INVARIANT] - 변수 'ws'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'maxLen'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
            let maxLen = 10
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'assetsSheet'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'asHdr'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'codeSheet'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'codeHdr'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  ...
  // [RUN-TIME STATE / INVARIANT] - 변수 'warnSheet'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
  const warnSheet = wb.addWorksheet('\u26A0\uFE0F Warnings')
  warnSheet.getColumn('A').width = 6
  warnSheet.getColumn('B').width = 80
  // [RUN-TIME STATE / INVARIANT] - 변수 'warnHdr'은 본 스코프 내에서 상태 보존 및 알고리즘 처리에 활용됨.
