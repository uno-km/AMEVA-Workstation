...
답변은 반드시 'PASS' 또는 'FAIL' 단 한 단어만 대답해야 합니다. 잡설이나 설명은 생략하십시오.
...
위 결과를 검정하여 PASS 또는 FAIL을 출력하십시오.`;
    ...
    // PASS 단어가 포함되어 있거나 FAIL 단어가 없는 경우 긍정 판정
    return verdictClean.includes('PASS') && !verdictClean.includes('FAIL');
  }
}
